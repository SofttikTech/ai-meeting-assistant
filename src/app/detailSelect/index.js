...
import FormControl from '@mui/material/FormControl';
import './index.css';
import { updateMeetingDetails } from '../../store/config';
...
// }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      receivedReferrals: anyReferrals,
      presentedSage: presentSage,
      client_id: localStorage.getItem("user_id"),
    };

    try {
      const data = await updateMeetingDetails(payload);
      alert("Meeting details updated successfully");
      history.push('/list-meetings');
    } catch (error) {
      console.error('Error:', error);
      alert("An error occurred while updating meeting details");
    }
  };
          ...
          <div className='selection-area'>
            <div className="auto-container">
              <div className='row'>
                  ...
                  <div className='selection-detail-box'>
                    <div className='select-box'>
                      <FormControl sx={{ m: 1, minWidth: 120 }}>
                        <Select
                          value={clientBuy}
                          onChange={(e) => setClientBuy(e.target.value)}
                          displayEmpty
                          inputProps={{ 'aria-label': 'Without label' }}
                          MenuProps={{
                            PaperProps: { className: "select-panel-dropdown" },
                          }}
                        >
                          <MenuItem value="" disabled>
                            <em>Did you ask the client to buy?</em>
                    ...
                    <div className='select-box'>
                      <div className='froup-form'>
                        ...
                        <TextField
                          ...
                          size="small"
                          value={whatCompany}
                          onChange={(e) => setWhatCompany(e.target.value)}
                          name='company'
                        />
                      </div>
                    </div>
                    <div className='select-box'>
                      <FormControl sx={{ m: 1, minWidth: 120 }}>
                        <Select
                          value={presentSage}
                          onChange={(e) => setPresentSage(e.target.value)}
                          displayEmpty
                          inputProps={{ 'aria-label': 'Without label' }}
                          MenuProps={{
                            PaperProps: { className: "select-panel-dropdown" },
                  ...
                  <div className='selection-detail-box'>
                    <div className='select-box'>
                      <FormControl sx={{ m: 1, minWidth: 120 }}>
                        <Select
                          value={clientPurchase}
                          onChange={(e) => setClientPurchase(e.target.value)}
                          displayEmpty
                          inputProps={{ 'aria-label': 'Without label' }}
                          MenuProps={{
                            PaperProps: { className: "select-panel-dropdown" },
                  ...
                  <div className='selection-detail-box'>
                    <div className='select-box'>
                      <FormControl sx={{ m: 1, minWidth: 120 }}>
                        <Select
                          ...
                          inputProps={{ 'aria-label': 'Without label' }}
                          MenuProps={{
                            PaperProps: { className: "select-panel-dropdown style-two" },
                          }}
                        >
                          <MenuItem value="" disabled>
                            <em>If purchased what product type?</em>
                    ...
                    <div className='select-box'>
                      <FormControl sx={{ m: 1, minWidth: 120 }}>
                        <Select
                          value={anyReferrals}
                          onChange={(e) => setAnyReferrals(e.target.value)}
                          displayEmpty
                          inputProps={{ 'aria-label': 'Without label' }}
                          MenuProps={{
                            PaperProps: { className: "select-panel-dropdown" },
                ...
                <div className='col-12'>
                  <div className='btn-area text-center mt-4'>
                    <button className='btn-style-new' type="submit">Submit</button>
                  </div>
                </div>
              </div>
            </div>
